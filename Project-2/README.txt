1. 
Item(ItemID (PRIMARY KEY), Name, Currently, Buy_Price, First_Bid, Number_of_Bids, Location, Longitude, Latitude, Country, Started, Ends, SellerID (FOREIGN KEY), Description)
